...
import { toNumber } from "./domain/formatters.js?v=20260620-client-clean-v1";
import { appLayout } from "./components/layout.js?v=20260620-client-clean-v1";
import { dietScreen } from "./screens/dietScreen.js?v=20260620-client-clean-v1";
import { feedingScreen } from "./screens/feedingScreen.js?v=20260620-client-clean-v1";
import { incomeScreen } from "./screens/incomeScreen.js?v=20260620-client-clean-v1";
import { consumptionScreen } from "./screens/consumptionScreen.js?v=20260620-client-clean-v1";
import { reportScreen } from "./screens/reportScreen.js?v=20260620-client-clean-v1";
import {
  ...
  updateLot,
  updateTreatment,
} from "./state/store.js?v=20260620-client-clean-v1";
