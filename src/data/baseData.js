export const baseDiets = {
  ...
  TRANSICION: {
    ...
    ingredients: [
      { id: "tr-1", name: "Rollo de Pasto", dryMatterPct: 0.88, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-2", name: "Sorgo Molido", dryMatterPct: 0.89149, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-3", name: "Maíz", dryMatterPct: 0.8835, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-4", name: "A. Arroz", dryMatterPct: 0.91, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-5", name: "A. Trigo", dryMatterPct: 0.886, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-6", name: "T. Girasol", dryMatterPct: 0.9, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-7", name: "Soya Cruda", dryMatterPct: 0.9, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-8", name: "Agua", dryMatterPct: 0.0001, inclusionMsPct: 0, costBsTon: 0 },
      { id: "tr-9", name: "Núcleo", dryMatterPct: 0.97, inclusionMsPct: 0, costBsTon: 0 },
    ],
  },
  TERMINACION: {
    id: "TERMINACION",
    ...
    ingredients: [
      { id: "te-1", name: "Rollo de Pasto", dryMatterPct: 0.88, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-2", name: "Sorgo Molido", dryMatterPct: 0.89149, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-3", name: "Maíz", dryMatterPct: 0.8835, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-4", name: "A. Arroz", dryMatterPct: 0.91, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-5", name: "A. Trigo", dryMatterPct: 0.886, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-6", name: "T. Girasol", dryMatterPct: 0.9, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-7", name: "H. de Soya", dryMatterPct: 0.9, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-8", name: "Agua", dryMatterPct: 0.0001, inclusionMsPct: 0, costBsTon: 0 },
      { id: "te-9", name: "Núcleo", dryMatterPct: 0.97, inclusionMsPct: 0, costBsTon: 0 },
    ],
  },
};
